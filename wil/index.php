...
?>
 ...
 <img src="mmoo.jpg" width="100%" height="200px" alt="">
 <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      <h1 class="display-4 fw-normal">هيا بنا لنصبح مبرمجين </h1>
      <p class="lead fw-normal">الوقت المتبقي </p>
      <h3 id="demo"></h3>
      <p class="lead fw-normal">لتصبح مبرمج  </p>
      <a class="btn btn-outline-secondary" href="#">لتصبح مبرمج</a>
    </div>
...
<form  action="<?php $_SERVER ['PHP SELF']?>" method="POST">
  ...
  <button type="submit" name="submit" class="btn btn-primary">ارسل معلوماتك</button>
   </form>
